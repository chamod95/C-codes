...
#define FIREBASE_HOST "https://voltaic-country-300908-default-rtdb.firebaseio.com"   // the project name address from firebase id
#define FIREBASE_AUTH "790aMVBKfHnAVRpfQGuiE8H4TM242dKB6rJTOyR7"                        // the secret key generated from firebase

#define WIFI_SSID "SLT_4GLTE"                        // input your home or public wifi name 
#define WIFI_PASSWORD "8F2EBEA0"                    //password of wifi ssid
 
#define DHTPIN D1                                                           // what digital pin we're connected to
#define DHTTYPE DHT11                                                       // select dht type as DHT 11 or DHT22
DHT dht(DHTPIN, DHTTYPE);        

int digitalPin =4;            // moisteure sensor pin
